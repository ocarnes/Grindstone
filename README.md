...
The production version of Grindstone is automatically loaded into Maya on startup. You can summon the Grindstone interface through a ![button](../plug-ins/gs_assets/GS_icon.png?raw=true) on the Custom shelf.
