...
class GeoEnum:
    ...
    def doCheck(self):
        ...
        # Array for nodes associated with geometry
        sceneScan = cmds.listNodeTypes("drawdb/geometry/mesh")
        ...
        formString = str(countHold) + " geometry node" + plural + '.'
